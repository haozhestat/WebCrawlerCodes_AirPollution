...
z="http://www.nmc.gov.cn/publish/forecast/ABJ/beijing_iframe.html"
...
write.table(cur_wea,file='/data/zoutao/crontab/rainfallbeijing.csv',col.names = FALSE,row.names=F,quote=F,sep=",",append=TRUE)
